...
import static org.apache.sentry.core.model.solr.Admin.COLLECTIONS;
...
public class TestSolrAdminOperations extends AbstractSolrSentryTestCase {
  ...
  public void testMetricsQuerySuccess() throws Exception {
    grantAdminPrivileges(ADMIN_USER, "role0", Admin.METRICS.getName(), SolrConstants.QUERY);
    ...
    try {
      ...
      revokeAdminPrivileges(ADMIN_USER, "role0", Admin.METRICS.getName(), SolrConstants.QUERY);
