...
public abstract class AbstractSolrSentryTestCase extends SolrCloudTestCase {
  ...
  public static void setupClass() throws Exception {
    ...
    for (int i = 0; i < 4; i++) {
      ...
      sentryClient.addRoleToGroups(TestSentryServer.ADMIN_USER, "role"+i, COMPONENT_SOLR, Collections.singleton("group"+i));
    }
    ...
    sentryClient.addRoleToGroups(TestSentryServer.ADMIN_USER, ADMIN_ROLE, COMPONENT_SOLR,
